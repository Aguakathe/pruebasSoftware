...
selenium.click("xpath=(.//*[normalize-space(text()) and normalize-space(.)='Síguenos en:'])[1]/following::a[1]")
selenium.open("https://www.linkedin.com/company/ginprosa-colombia/")
selenium.open("https://www.ginprosacol.com.co/preliminar/mockup/index.html")
selenium.click("xpath=(.//*[normalize-space(text()) and normalize-space(.)='Síguenos'])[1]/following::a[1]")
